...
import { View, ScrollView, StyleSheet, Alert, BackHandler, Image, Modal, TouchableOpacity, KeyboardAvoidingView, Platform } from 'react-native';
  ...
  constructor(props) {
    ...
    this.state = {
      messages: [
        ...
        createTextMessage('Cruz, Daniel Y.'),
        createTextMessage('EmergingTech 3'),
        createLocationMessage({
          latitude: 14.626293326051618,
          longitude: 121.06262899275816,
        }),
      ],
